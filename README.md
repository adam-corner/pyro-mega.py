...
**Note:** This is a modified version of [mega.py](https://github.com/odwyersoftware/mega.py). Made for [Mega.nz-Bot](https://github.com/adam-corner/Mega.nz-Bot).
It's a [Open Source Mega.nz Downloader Bot](https://github.com/adam-corner/Mega.nz-Bot) so you can get idea about How to use this library for Telegram Bots (PyrogramOnly) 🥳
